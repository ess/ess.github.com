...
But there's no Aruba for Go. To that end, I've just released [jamaica](https://github.com/ess/jamaica) v1.0.1. As a fun aside, when I first started working on jamaica, I'd decided to rename it to "keylargo," but I apparently forgot about this along the way.
